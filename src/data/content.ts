...
const blogItems: TimelineItem[] = [
  {
    ...
    vi: {
      title: 'Buổi gặp Shogi mùa xuân tại Otter Shogi',
      excerpt: 'Một buổi chơi cờ nhẹ nhàng dành cho người mới, khách quen và những ai muốn thử shogi lần đầu.',
      body: [
        'Otter Shogi tổ chức một buổi gặp nhỏ để mọi người có thể thử bàn cờ, học lại luật cơ bản và chơi vài ván chậm trong không khí thân mật.',
        'Không gian được chuẩn bị theo tông washi và gỗ trầm, có khu vực hướng dẫn riêng cho người mới. Đây là mẫu bài viết demo để hình dung cách trang hoạt động sẽ hiển thị.',
      ],
      details: ['Hướng dẫn luật cơ bản trong 20 phút', 'Bàn chơi thử cho nhóm 2-4 người', 'Góc chụp ảnh với bàn shogi cổ điển'],
    },
    en: {
      title: 'Spring Shogi Meetup at Otter Shogi',
      excerpt: 'A quiet play session for new players, regular customers, and anyone trying shogi for the first time.',
      body: [
        'Otter Shogi hosts a small meetup where guests can try boards, refresh the basic rules, and play slow games in a relaxed setting.',
        'The space is prepared with warm washi and wood tones, plus a separate learning area for beginners. This is demo content for the activity layout.',
      ],
